...
-(NSMutableDictionary *)makeDictionary:(id)plistOutputArray {
...
self.thankYou = [[NSMutableDictionary alloc] init];
    
for (int i = 0; i < [plistOutputArray count]; i++) {
    NSDictionary *dictionary = [[NSDictionary alloc] init];
    dictionary = [plistOutputArray objectAtIndex:i];
